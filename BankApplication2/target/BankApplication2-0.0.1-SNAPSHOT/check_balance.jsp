    ...
    <div class="login_main_cont">      
        <div class="login_cont group login">
            ...
            <div class="login_form">
              <form class="formClass" method="post" action="check">
                <fieldset>                
                    <label for="accno"><span>Username</span></label>
                    <input id="accno" name="accno" class="validate[required] text-input" placeholder="Account Number" type="text" tabindex="1" accesskey="u">                
                </fieldset>
               
                <fieldset class="login_submit"><button type="submit" class="btn">CHECK BALANCE</button></fieldset>
        ...
        <div class="login_cont group sign_up">
            ...
            <h2>Sign up</h2>
            <div class="login_form">          
              <form class="formClass" action="check">
                <fieldset>                
