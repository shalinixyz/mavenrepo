  ...
  <body> 
    ...
    <div class="login_main_cont">      
        <div class="login_cont group login">
          ...
          <!--    <h2>Login</h2>  -->        
            <div class="login_form">
              <form class="formClass" method="post" action="deposit">
                <fieldset>                
                    <label for="username"><span>Account number</span></label>
                    <input id="username" name="accno" class="validate[required] text-input" placeholder="Account Number" type="text" tabindex="1" accesskey="u">                
                </fieldset>
                <fieldset>                
                    <label class="amount" for="amount"><span>amount</span></label>
                    <input id="amount" name="amount" class="validate[required] text-input" placeholder="amount" type="text" tabindex="2" accesskey="p">                
                </fieldset>
                <fieldset class="login_submit"><button type="submit" class="btn">DEPOSIT</button></fieldset>
        ...
        <div class="login_cont group sign_up">
            ...
            <h2>Sign up</h2>
            <div class="login_form">          
              <form class="formClass" action="deposit">
                <fieldset>                
